...
pub fn magnetization(
    ...
    let [mut mhatx, mut mhaty, mut mhatz] = [vec![0.0; n_elem], vec![0.0; n_elem], vec![0.0; n_elem]];
        ...
        match solver {
            ...
            Solver::Tet4Direct(n_threads) => {
                for i in 0..n_elem {
                    ...
                    let elem_nodes = [
                        nodes[elem[0] as usize], nodes[elem[1] as usize], nodes[elem[2] as usize], nodes[elem[3] as usize]
                    ];
