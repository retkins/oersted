...
pub mod point;
pub use point::{a_current_point, a_mag_point, h_current_point, h_mag_point, h_point};
pub mod tet4;
pub use tet4::{a_current_tet4, a_mag_tet4, h_current_tet4, h_mag_tet4};
pub mod tet4_edge;
...
pub fn monopole(
    ...
    ((cx, cy, cz), (mx_total, my_total, mz_total))
}
