...
def bfield_direct(
    centroids: NDArray[float64], vol: NDArray[float64], jdensity: NDArray[float64], targets: NDArray[float64], nthreads: int = 0
) -> NDArray[float64]:
...
def bfield_hexahedron(nodes: NDArray[float64], jdensity: NDArray[float64], target: NDArray[float64]) -> NDArray[float64]:
