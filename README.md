...
![Timing Results](docs/figs/benchmarks/octree_benchmarks.svg)
...
![Octree times](docs/figs/benchmarks/octree_times.svg)
...
* A low-frequency time-domain eddy current solver, for evaluating induced currents in 
passive conductors under the effect of rapidly changing external fields
...
- v0.5.0 
    - [x] Eddy current solver for low-frequency time domain problems
- v0.6.0 
