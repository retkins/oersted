...
* A 'point' finite element source, which is orders of magnitude faster and highly accurate 
...
- v0.2.0
    ...
    - [x] Finite element meshing and force calculations
- v0.3.0
    - [ ] Solid angle calculations to replace the edge-integral formulations for fields 
